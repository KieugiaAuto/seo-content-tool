...
function saoChepMoTaNgan() {
    ...
    // ⛔ KIỂM TRA CHỐT KHÓA Ở ĐÂY
    if (btn.dataset.requireSlug === "true" && btn.dataset.slugCopied === "false") {
        hienThongBao('⚠️ Vui lòng bấm "Copy Slug" trước !', 'error');
        return; // Dừng lại, không copy mô tả ngắn
    }
